...
plot_by_wavelength(sorted_data_df, "OD600", "average", -2, title_extra= "t12", save_image= True)
plot_by_wavelength(sorted_data_df, "OD600", "average", -1, title_extra= "t24", save_image= True)
plot_by_wavelength(sorted_data_df, "OD600", "all", -2, title_extra= "t12", save_image= True)
plot_by_wavelength(sorted_data_df, "OD600", "all", -1, title_extra= "t24", save_image= True) """